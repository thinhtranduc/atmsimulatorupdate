...
public final class Bank {
	...
	public static void addUser(String firstName, String lastName, String pin, String uuid, String type) {
		// create a new User object
		if(type.equals("1")) {
			Customer newUser = new Customer(firstName, lastName, pin, uuid);
			users.add(newUser);
			// create a savings account
			Account newAccount = new Account("Savings", newUser);
			Account newAccount1 = new Account("Checking", newUser);
			...
			Staff staff = new Staff(firstName, lastName, pin, uuid);
			users.add(staff);
		}
	}
