...
public class BankView extends View {
	...
	public int printUserMenu(User theUser) {
	...
	public void showTransHistory(User user) {
		int theAcct;
		do {
	...
	public static Transfer transferFunds(User theUser) {
		int fromAcct;
		int toAcct;
		double amount;
		double acctBal;
	...
	public static Transfer withdrawFunds(User theUser) {
		int fromAcct;
		double amount;
		double acctBal;
		String memo;
	...
	public static Transfer depositFunds(User theUser) {
		int toAcct;
		double amount;
		String memo;
