package com.btmglobal.simulator.atm.control;
...
public static void printUserMenu(User theUser, Scanner sc) {
			...
			switch (choice) {
			case 1:
				Control.showTransHistory(theUser, sc);
				break;
			case 2:
				Control.withdrawFunds(theUser, sc);
				break;
			case 3:
				Control.depositFunds(theUser, sc);
				break;
			case 4:
				Control.transferFunds(theUser, sc);
				break;	
			case 5:
				sc.nextLine();
				break;
			...
			if(choice != 5) {
				Control.printUserMenu(theUser, sc);
			}
		}
